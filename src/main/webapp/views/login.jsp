			...
			<div class="row">
				<div class="d-flex align-items-center justify-content-between py-2">
					...
					<div class="col-sm-10 co-lg-10 p-0 d-flex justify-content-end">
						<h1 class="fw-bold text-white">Đăng Nhập</h1>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="border rounded shadow" style="width: 400px">
				...
				<div class="pt-0 pb-3 px-3">
					<form:form action="/login" modelAttribute="account" method="post">
						...
						<div class="form-group my-3">
							<button type="submit"
								class="form-control btn checkout text-white">Đăng Nhập</button>
						</div>
						<div class="mb-3 d-flex justify-content-between">
							<div class="">
								<label class="checkbox-wrap text_price"> <input
									type="checkbox" checked> Nhớ Mật Khẩu
								</label>
							</div>
							<div class="">
								<a class="text-decoration-none text_price" href="/forgetPassword">Quên Mật
									Khẩu?</a>
							</div>
						</div>
					</form:form>
				...
				<div class="d-flex align-items-center justify-content-center"
					...
					<div class="d-flex text-center">
						<p class="text-secondary me-2">Bạn mới biết đến HXLuong
							Watches?</p>
						<a class="text-decoration-none text_price" href="/signup">Đăng
							Ký</a>
					</div>
				</div>
			</div>
